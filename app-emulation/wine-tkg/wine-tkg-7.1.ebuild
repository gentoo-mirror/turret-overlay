...
inherit autotools estack eutils flag-o-matic gnome2-utils multilib multilib-minimal pax-utils plocale toolchain-funcs virtualx xdg-utils

MY_PN="${PN%%-*}"
MY_P="${MY_PN}-${PV}"

	EGIT_REPO_URI="https://github.com/Tk-Glitch/wine-tkg"
	EGIT_COMMIT="67d5deb83d27db808005be58a6ea62b86d0168a9"
	inherit git-r3
	SRC_URI=""
	KEYWORDS="-* ~amd64 ~x86"
